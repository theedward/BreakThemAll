...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		path.set ("img/BIG.png", "img/BIG.png");
		type.set ("img/BIG.png", AssetType.IMAGE);
		path.set ("img/breakout.png", "img/breakout.png");
		type.set ("img/breakout.png", AssetType.IMAGE);
		path.set ("img/EXTRA.png", "img/EXTRA.png");
		type.set ("img/EXTRA.png", AssetType.IMAGE);
		path.set ("img/FAST.png", "img/FAST.png");
		type.set ("img/FAST.png", AssetType.IMAGE);
		path.set ("audio/ball_hit_platform.wav", "audio/ball_hit_platform.wav");
		type.set ("audio/ball_hit_platform.wav", AssetType.SOUND);
		path.set ("audio/explosion.wav", "audio/explosion.wav");
		type.set ("audio/explosion.wav", AssetType.SOUND);
		path.set ("audio/intro_pokemon.wav", "audio/intro_pokemon.wav");
		type.set ("audio/intro_pokemon.wav", AssetType.SOUND);
		path.set ("audio/levels/level1_sonic.wav", "audio/levels/level1_sonic.wav");
		type.set ("audio/levels/level1_sonic.wav", AssetType.SOUND);
		path.set ("audio/levels/level2_super_mario.wav", "audio/levels/level2_super_mario.wav");
		type.set ("audio/levels/level2_super_mario.wav", AssetType.SOUND);
		path.set ("audio/levels/level3_tetris.wav", "audio/levels/level3_tetris.wav");
		type.set ("audio/levels/level3_tetris.wav", AssetType.SOUND);
		path.set ("audio/power_up.wav", "audio/power_up.wav");
		...
		path.set ("audio/levels/level3_tetris.wav", "audio/levels/level3_tetris.wav");
		type.set ("audio/levels/level3_tetris.wav", AssetType.SOUND);
		path.set ("levels/Level1.txt", "levels/Level1.txt");
		type.set ("levels/Level1.txt", AssetType.TEXT);
		path.set ("levels/Level2.txt", "levels/Level2.txt");
		type.set ("levels/Level2.txt", AssetType.TEXT);
		path.set ("levels/Level3.txt", "levels/Level3.txt");
