...
@:keep @:bind #if display private #end class __ASSET__audio_ball_hit_platform_wav extends null { }
@:keep @:bind #if display private #end class __ASSET__audio_explosion_wav extends null { }
@:keep @:bind #if display private #end class __ASSET__audio_intro_pokemon_wav extends null { }
@:keep @:bind #if display private #end class __ASSET__audio_levels_level1_sonic_wav extends null { }
@:keep @:bind #if display private #end class __ASSET__audio_levels_level2_super_mario_wav extends null { }
@:keep @:bind #if display private #end class __ASSET__audio_levels_level3_tetris_wav extends null { }
@:keep @:bind #if display private #end class __ASSET__audio_power_up_wav extends null { }
@:keep @:bind #if display private #end class __ASSET__audio_levels_level2 extends null { }
@:keep @:bind #if display private #end class __ASSET__audio_levels_level3 extends null { }
@:keep @:bind #if display private #end class __ASSET__audio_levels_level4 extends null { }
@:keep @:bind #if display private #end class __ASSET__levels_level1_txt extends null { }
@:keep @:bind #if display private #end class __ASSET__levels_level2_txt extends null { }
@:keep @:bind #if display private #end class __ASSET__levels_level3_txt extends null { }
